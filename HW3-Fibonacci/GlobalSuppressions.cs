...
[assembly: SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1633:File should have header", Justification = "Didn't make it.")]
[assembly: SuppressMessage("StyleCop.CSharp.OrderingRules", "SA1204:Static elements should appear before instance elements", Justification = "Because I wanted useless method at the end and didn't want to get rid of it.", Scope = "member", Target = "~M:HW3_Fibonacci.FibonacciTextReader.Fibonacci(System.Int32)~System.Collections.Generic.List{System.Numerics.BigInteger}")]
